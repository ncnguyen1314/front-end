...
export default {
  ...
  methods: {
    createStackedBar(data) {
      ...
      var subgroups = ["dagiaohang", "hoantra", "dahuy"];
      var stackedcolor = [];
      ...
      var mousemove = function (event, d) {
        tooltip
          .style("left", d.x0 + 90 + "px") // It is important to put the +90: other wise the tooltip is exactly where the point is an it creates a weird effect
